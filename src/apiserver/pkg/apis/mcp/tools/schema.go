...
func RegisterSchemaTools(server *mcp.Server) {
	...
	mcp.AddTool(server, &mcp.Tool{
		...
		Description: "Return APISIX JSON schema for a resource type and MCP-supported schema version (3.13.X or 3.17.X). " +
	...
	mcp.AddTool(server, &mcp.Tool{
		...
		Description: "Return APISIX plugin schema by plugin_name and MCP-supported schema version (3.13.X or 3.17.X). " +
