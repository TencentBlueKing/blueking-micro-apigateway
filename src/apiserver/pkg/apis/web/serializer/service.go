...
// ServiceInfo Service 基本信息
type ServiceInfo struct {
	AutoID     int             `json:"-"`
	ID         string          `json:"id"`                                                          // 资源apisix资源id
	Name       string          `json:"name" binding:"required" validate:"serviceName"`              // service名称
	UpstreamID string          `json:"upstream_id" validate:"upstreamID"`                           // 上游服务地址ID
	Config     json.RawMessage `json:"config" validate:"apisixConfig=service" swaggertype:"object"` // 配置数据(json格式)
}
...
// ServiceListResponse Service 列表
type ServiceListResponse []ServiceOutputInfo

// ServiceOutputInfo ...
type ServiceOutputInfo struct {
...
// ServiceDropDownListResponse Service 下拉列表
type ServiceDropDownListResponse []ServiceDropDownOutputInfo

// ServiceDropDownOutputInfo ...
type ServiceDropDownOutputInfo struct {
...
// ValidateServiceID 校验 serviceID
func ValidateServiceID(ctx context.Context, fl validator.FieldLevel) bool {
...
func ValidateServiceName(ctx context.Context, fl validator.FieldLevel) bool {
