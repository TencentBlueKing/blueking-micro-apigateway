...
// Package importflow contains resource import planning and validation helpers.
package importflow
...
func BuildImportIndex(
	...
	for resourceType, resourceInfoList := range resourceInfoTypeMap {
		...
		dbResources, err := resourcebiz.BatchGetResources(ctx, resourceType, []string{})
		if err != nil {
			return nil, err
		}
...
func loadExistingImportResources(
	...
	allResourceList, err := resourcebiz.GetResourceByIDs(ctx, resourceType, []string{})
	if err != nil {
...
func buildImportSchemaIndex(
	...
	existsPluginSchemaMap, err := schemabiz.GetCustomizePluginSchemaMap(ctx)
	if err != nil {
