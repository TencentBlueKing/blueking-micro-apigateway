...
func TestInjectRequiredResourceIDForValidation(t *testing.T) {
	tests := []struct {
		...
		{
			name:         "injects required id in 3.17",
...
func TestPrepareWebValidationPayload(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:             "consumer group injects generated id and keeps name on 3.17",
			resourceType:     constant.ConsumerGroup,
			version:          constant.APISIXVersion317,
			configRaw:        `{"name":"consumer-group-demo","plugins":{}}`,
			resourceID:       "cg-generated-id",
			fallbackIdentity: "fallback-name",
			wantPayload:      `{"name":"consumer-group-demo","plugins":{},"id":"cg-generated-id"}`,
			wantIdentity:     "cg-generated-id",
		},
		{
		...
		{
			name:             "proto on 3.17 uses fallback identity as validation name",
			resourceType:     constant.Proto,
			version:          constant.APISIXVersion317,
			configRaw:        `{"content":"syntax = \"proto3\";"}`,
			fallbackIdentity: "proto-demo",
