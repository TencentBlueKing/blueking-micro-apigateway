...
func newGateway(db *gorm.DB, opts ...gen.DOOption) gateway {
	...
	_gateway.Mode = field.NewUint8(tableName, "mode")
	_gateway.Maintainers = field.NewField(tableName, "maintainers")
	_gateway.Desc = field.NewString(tableName, "desc")
	_gateway.APISIXType = field.NewString(tableName, "apisix_type")
	_gateway.APISIXVersion = field.NewString(tableName, "apisix_version")
	_gateway.EtcdConfig = field.NewField(tableName, "etcd_config")
	...
	_gateway.UpdatedAt = field.NewTime(tableName, "updated_at")
...
func (g *gateway) updateTableName(table string) *gateway {
	...
	g.Mode = field.NewUint8(table, "mode")
	g.Maintainers = field.NewField(table, "maintainers")
	g.Desc = field.NewString(table, "desc")
	g.APISIXType = field.NewString(table, "apisix_type")
	g.APISIXVersion = field.NewString(table, "apisix_version")
	g.EtcdConfig = field.NewField(table, "etcd_config")
...
func (g *gateway) fillFieldMap() {
	...
	g.fieldMap["maintainers"] = g.Maintainers
	g.fieldMap["desc"] = g.Desc
	g.fieldMap["apisix_type"] = g.APISIXType
	g.fieldMap["apisix_version"] = g.APISIXVersion
	g.fieldMap["etcd_config"] = g.EtcdConfig
